...
class DiazoThemeTest(BaseTemplateTest):
    ...
    def test_core_template(self):
        ...
        expected = [
            ...
            p_src + '/mytheme/diazo_resources/install',
            p_src + '/mytheme/diazo_resources/install/.gitkeep',
            p_src + '/mytheme/diazo_resources/install/registry.xml',
            ...
            p_src + '/mytheme/diazo_resources/uninstall',
            p_src + '/mytheme/diazo_resources/uninstall/.gitkeep',
            p_src + '/mytheme/diazo_resources/uninstall/registry.xml',
    ...
    def test_customer_template(self):
        ...
        expected = [
            ...
            p_src + '/domain/diazo_resources/install',
            p_src + '/domain/diazo_resources/install/.gitkeep',
            p_src + '/domain/diazo_resources/install/registry.xml',
            ...
            p_src + '/domain/diazo_resources/uninstall',
            p_src + '/domain/diazo_resources/uninstall/.gitkeep',
            p_src + '/domain/diazo_resources/uninstall/registry.xml',
